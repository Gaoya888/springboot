...
import com.bo.spring.model.entity.M3U8;

public class M3U8Util {
	public static String TEMP_DIR = "temp";
	public static int connTimeout = 30 * 60 * 1000;
	public static int readTimeout = 30 * 60 * 1000;
	public static String s1 = "https://video.pearvideo.com/hls/live-cut/pearvideo/1543145-1555414264-hd.m3u8";
	...
	public static void main(String[] args) {
		...
		mergeFiles(tfile.listFiles(), "test3.ts");
	}
